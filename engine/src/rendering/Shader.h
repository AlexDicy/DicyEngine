...
public:
    ...
    virtual void uploadUniformVec2Int(const std::string& name, const glm::ivec2& vector) const = 0;
    virtual void uploadUniformVec2(const std::string& name, const glm::vec2& vector) const = 0;
